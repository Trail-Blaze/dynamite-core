    ...
    dynamite: {
      common: {
        not_found: new ErrDef(
          "errors.com.dynamite.common.not_found",
          "Sorry the resource you were trying to find could not be found or has not yet been implemented.",
          1004,
          404
        ),
        ...
        throttled: new ErrDef(
          "errors.com.dynamite.common.throttled",
          "Operation access is limited by throttling policy, please try again in {0} second(s).",
          1041,
          429
        ),
      },
      ...
      modules: {
        gameplayutils: {
          not_enough_mtx: new ErrDef(
            "errors.com.dynamite.modules.gameplayutils.not_enough_mtx",
        ...
        profiles: {
          invalid_command: new ErrDef(
            ...
            "{0} is not valid on {1} profiles ({2})",
            12801,
            400
          ),
